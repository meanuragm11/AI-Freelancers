...
type SecurityModal = 'email' | 'password' | 'mfa' | null;
        ...
        <div className="flex-1 min-w-0">
          ...
          {activeTab === 'security' && (
            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4">
              ...
              <DeleteAccountSection description="Permanently delete your account, active projects, and purchased AI Solution licenses. This action cannot be undone." />
            </div>
          )}
