...
function BuilderInboxContent() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans flex flex-col overflow-x-hidden">
      ...
      {/* HEADER */}
      <div className="bg-white border-b border-slate-200 sticky top-16 sm:top-20 z-40 shadow-sm">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between min-w-0">
          <div className="flex items-center gap-3 sm:gap-4 min-w-0">
            <Link 
              href="/builder/dashboard" 
              className="min-h-11 min-w-11 bg-slate-50 hover:bg-slate-100 border border-slate-200 rounded-full flex items-center justify-center text-slate-500 transition-colors shrink-0"
            >
            ...
            <div>
              <h1 className="text-lg sm:text-xl font-black text-slate-900 leading-tight truncate">Inbox</h1>
      ...
      <div className="flex-1 max-w-[1400px] mx-auto w-full p-3 sm:p-4 md:p-6 lg:p-8 animate-in fade-in duration-500 min-w-0">
        <MessagingInterface 
          currentUser={user} 
          userRole="builder"
